...
#if 1
        // Bank0
        { avioDhubChMap_ag_MA0_R_A0, AG_DHUB_BANK0_START_ADDR, AG_DHUB_BANK0_START_ADDR, 0, 0, dHubChannel_CFG_MTU_128byte, 0, 0, 1},
        { avioDhubChMap_ag_MA1_R_A0, AG_DHUB_BANK0_START_ADDR, AG_DHUB_BANK0_START_ADDR,0, 0, dHubChannel_CFG_MTU_128byte, 0, 0, 1},
        { avioDhubChMap_ag_MA2_R_A0, AG_DHUB_BANK0_START_ADDR, AG_DHUB_BANK0_START_ADDR, 0, 0, dHubChannel_CFG_MTU_128byte, 0, 0, 1},
        { avioDhubChMap_ag_MA3_R_A0, AG_DHUB_BANK0_START_ADDR, AG_DHUB_BANK0_START_ADDR, 0, 0, dHubChannel_CFG_MTU_128byte, 0, 0, 1},
        { avioDhubChMap_ag_SA0_R_A0, AG_DHUB_BANK0_START_ADDR, AG_DHUB_BANK0_START_ADDR+32, 32, 1024, dHubChannel_CFG_MTU_128byte, 0, 0, 1},
        { avioDhubChMap_ag_MIC0_W_A0, AG_DHUB_BANK0_START_ADDR+1024+32, AG_DHUB_BANK0_START_ADDR+1024+32*2, 32, 2048, dHubChannel_CFG_MTU_128byte, 0, 0, 1},
        { avioDhubChMap_ag_MIC1_W_A0, AG_DHUB_BANK0_START_ADDR, AG_DHUB_BANK0_START_ADDR, 0, 0, dHubChannel_CFG_MTU_128byte, 0, 0, 1},
